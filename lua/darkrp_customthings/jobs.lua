...
yourself to Admin Box till called upon by a person
...
TEAM_SWAT = AddExtraTeam("SWAT",Color(0,120,255,255),"models/player/urban.mdl",[[ You are only called in when
regular police cannot handle the situation.
You are the brute force animals of the police']],{"weapon_m4", "arrest_stick", "unarrest_stick", "stunstick", "door_ram", "weaponchecker", "weapon_glock"},"SWAT",2,85,0,true)
...
TEAM_DRUG = AddExtraTeam("Drug Dealer", Color(141, 0, 141, 255), "models/player/eli.mdl", [[You are the Joke and Joke accessories salesman!
You sell jokes and... ahhh who am I kidding. Drugs. You sell drugs.']], {}, "drugdealer", 3, 30, 0, false)
